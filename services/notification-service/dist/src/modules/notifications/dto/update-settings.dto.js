...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'user123', description: 'The user ID' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
], UpdateNotificationSettingsDto.prototype, "userId", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: true, description: 'Enable/disable email notifications' }),
    (0, class_validator_1.IsBoolean)(),
    __metadata("design:type", Boolean)
], UpdateNotificationSettingsDto.prototype, "emailEnabled", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: false, description: 'Enable/disable promotional emails' }),
    (0, class_validator_1.IsBoolean)(),
    __metadata("design:type", Boolean)
], UpdateNotificationSettingsDto.prototype, "promotionalEmails", void 0);
